...
async def graph_start_container_executor(
    ...
    try:
        ...
        from ....models import Project, Container, ContainerConnection
        ...
        if not project:
            return error_output(
                ...
                suggestion="Ensure you're in a valid project context"
            )
...
async def graph_container_status_executor(
    ...
    logger.info(f"[graph_container_status] db={db is not None}, user_id={user_id}, project_id={project_id}, project_slug={project_slug}")
...
CONTAINER_TOOLS: List[Tool] = [
    Tool(
        ...
        parameters={
            ...
            "properties": {
                "container_id": {
                    "type": "string",
                    "description": "UUID of the container to start"
                }
            },
    ...
    Tool(
        ...
        parameters={
            ...
            "properties": {
                "container_id": {
                    "type": "string",
                    "description": "UUID of the container to stop"
                }
            },
            "required": ["container_id"]
        },
    ...
    Tool(
        ...
        examples=[
            '{"tool_name": "graph_start_all", "parameters": {}}'
        ]
    ),
    Tool(
        name="graph_stop_all",
        ...
        examples=[
            '{"tool_name": "graph_stop_all", "parameters": {}}'
        ]
    ),
    Tool(
        ...
        examples=[
            '{"tool_name": "graph_container_status", "parameters": {}}'
        ]
    ),
]
