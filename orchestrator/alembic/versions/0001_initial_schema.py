...
def upgrade() -> None:
    ...
    # ==========================================================================
    op.create_table('marketplace_bases',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('name', sa.String(), nullable=False),
        sa.Column('slug', sa.String(), nullable=False),
    ...
    op.create_index('ix_project_snapshots_snapshot_name', 'project_snapshots', ['snapshot_name'], unique=False)
    op.create_index('ix_project_snapshots_project_id', 'project_snapshots', ['project_id'], unique=False)
    op.create_index('ix_project_snapshots_project_created', 'project_snapshots', ['project_id', 'created_at'])
    op.create_index('ix_project_snapshots_soft_delete', 'project_snapshots', ['is_soft_deleted', 'soft_delete_expires_at'])

    # ==========================================================================
    # Deployment Credentials (needed before containers for credentials_id FK)
    # ==========================================================================
    op.create_table('deployment_credentials',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('user_id', sa.UUID(), nullable=False),
        sa.Column('project_id', sa.UUID(), nullable=True),
    ...
    op.create_index('ix_deployment_credentials_user_id', 'deployment_credentials', ['user_id'], unique=False)
    op.create_index('ix_deployment_credentials_project_id', 'deployment_credentials', ['project_id'], unique=False)
    ...
    op.create_table('containers',
        ...
        sa.ForeignKeyConstraint(['credentials_id'], ['deployment_credentials.id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    # ==========================================================================
    op.create_table('container_connections',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('project_id', sa.UUID(), nullable=False),
    ...
    # Agent Command Logs
    # ==========================================================================
    op.create_table('agent_command_logs',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('user_id', sa.UUID(), nullable=False),
        sa.Column('project_id', sa.UUID(), nullable=False),
    ...
    # Pod Access Logs
    # ==========================================================================
    op.create_table('pod_access_logs',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    # Shell Sessions
    # ==========================================================================
    op.create_table('shell_sessions',
        sa.Column('id', sa.UUID(), nullable=False),
    ...
    # ==========================================================================
    op.create_table('git_provider_credentials',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    op.create_index('ix_git_provider_credentials_user_provider', 'git_provider_credentials', ['user_id', 'provider'], unique=True)
    ...
    # ==========================================================================
    op.create_table('user_purchased_agents',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    # ==========================================================================
    op.create_table('user_purchased_bases',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    # User Custom Models
    # ==========================================================================
    op.create_table('user_custom_models',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('user_id', sa.UUID(), nullable=False),
    ...
    # Agent Co-Installs
    # ==========================================================================
    op.create_table('agent_co_installs',
        sa.Column('id', sa.UUID(), nullable=False),
        sa.Column('agent_id', sa.UUID(), nullable=False),
        ...
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
        sa.ForeignKeyConstraint(['agent_id'], ['marketplace_agents.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['related_agent_id'], ['marketplace_agents.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_index('ix_agent_co_installs_agent_id', 'agent_co_installs', ['agent_id'], unique=False)
    op.create_index('ix_agent_co_installs_related_agent_id', 'agent_co_installs', ['related_agent_id'], unique=False)
    ...
    op.create_index('ix_marketplace_transactions_id', 'marketplace_transactions', ['id'], unique=False)
    ...
    op.create_index('ix_credit_purchases_stripe_payment_intent', 'credit_purchases', ['stripe_payment_intent'], unique=True)
    ...
    op.create_index('ix_feedback_posts_upvote_count', 'feedback_posts', ['upvote_count'], unique=False)
    ...
    op.create_index('ix_feedback_upvotes_feedback_id', 'feedback_upvotes', ['feedback_id'], unique=False)
    ...
    op.create_index('ix_feedback_comments_feedback_id', 'feedback_comments', ['feedback_id'], unique=False)
    op.create_index('ix_feedback_comments_created_at', 'feedback_comments', ['created_at'], unique=False)
    ...
    # ==========================================================================
    op.create_table('kanban_task_comments',
        sa.Column('id', sa.UUID(), nullable=False),
