        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Create your account and join thousands of developers shipping production-ready applications in minutes.
            </p>
          </div>
          ...
          <div className="mb-6 flex items-center">
            ...
            <span className="px-4 text-gray-400 text-xs font-medium">Or sign up with email</span>
            <div className="flex-1 border-t border-gray-200"></div>
          </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-lg text-center">
          ...
          <div className="inline-flex items-center gap-2 mb-12 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
            ...
            <span className="text-white text-xs font-semibold tracking-wider">LOVED BY DEVELOPERS</span>
          </div>
