...
export const AVAILABLE_MARKERS: Marker[] = [
  // System markers
  {
    ...
    label: 'Edit Mode',
    category: 'system',
    description: 'Current edit mode (allow/ask/plan)',
  },
  {
    key: 'mode_instructions',
    label: 'Mode Instructions',
    category: 'system',
    description: 'Detailed instructions for current mode',
  },
  {
    key: 'timestamp',
    label: 'Timestamp',
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-xs text-[var(--text)]/50 mt-4 p-3 bg-[var(--text)]/5 rounded-lg border border-[var(--text)]/10">
        ...
        <p>
          Click any marker above to insert it at the cursor position in your system prompt. Markers
          are replaced with actual values when the agent runs.
        </p>
      </div>
    </div>
  );
